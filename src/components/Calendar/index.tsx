        ...
        params: {
          ...
          month:
            String(currentDate.get('month') + 1).length === 1
              ...
              : currentDate.get('month') + 1, // pois no mysql janeiro é representado pelo nº1
        },
      })
                  ...
                  return (
                    <td key={date.toString()}>
                      <CalendarDay
                        ...
                        disabled={disabled}
                        isSelected={isDateSelected} // Nova propriedade para indicar se este é o dia selecionado
                      >
                        {date.get('date')}
                      </CalendarDay>
                    </td>
